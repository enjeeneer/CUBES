...
parser.add_argument("--temperature_margin", type=float, default=20)
parser.add_argument("--temp_range_low", type=float, default=20)
parser.add_argument("--temp_range_high", type=float, default=20)
parser.add_argument("--occupancy_schedule", type=str)
parser.add_argument("--map_setpoints_to_comfort_space", type=str, default="False")
