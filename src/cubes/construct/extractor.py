...
class Extractor:
    ...
    def create_building_config_object(self):
        building_config = bc.BuildingConfig(
            ...
            natural_ventilation_for_cooling_rate=2,
            natural_ventilation_for_cooling_indoor_t_range=(22, 30),
            ...
            lighting_schedule="",
            heating_setpoint_t=20,
            heating_setback_t=15,
            cooling_setpoint_t=25,
            cooling_setback_t=30,
        )
