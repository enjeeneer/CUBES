...
utc_col = pd.read_csv("/workspaces/CUBES/cubes/data/occupants/rep_0.sch")[
    "UTC_Time"
]  # Load UTC column once
...
monitor_files = [
    (
        "Eplus-env-10-18_thermostat_rbc_eco_year_2023_case_0_rep_H28_zone_0_inactive_threshold_30_comforttemp_20.0_setbacktemp_16_pattern_twice_timesteps_60_holiday_check-res1/Eplus-env-sub_run1/monitor.csv",
        "zone0_monitor_condensed.csv",
    ),
    (
        "Eplus-env-10-18_thermostat_rbc_eco_year_2023_case_0_rep_H28_zone_9_inactive_threshold_30_comforttemp_20.0_setbacktemp_16_pattern_twice_timesteps_60_holiday_check-res1/Eplus-env-sub_run1/monitor.csv",
        "zone9_20_16_monitor_condensed.csv",
    ),
    (
        "Eplus-env-10-18_thermostat_rbc_eco_year_2023_case_0_rep_H28_zone_9_inactive_threshold_30_comforttemp_21.0_setbacktemp_15_pattern_twice_timesteps_60_setback_check-res1/Eplus-env-sub_run1/monitor.csv",
        "zone9_21_15_monitor_condensed.csv",
    ),
    (
        "Eplus-env-10-21_thermostat_rbc_eco_year_2023_case_0_rep_H28_zone_9_inactive_threshold_30_comforttemp_20.5_setbacktemp_16_pattern_twice_timesteps_60_setback_check-res1/Eplus-env-sub_run1/monitor.csv",
        "zone9_20.5_16_monitor_condensed.csv",
    ),
    (
        "Eplus-env-10-21_thermostat_rbc_eco_year_2023_case_0_rep_H28_zone_9_inactive_threshold_30_comforttemp_21.0_setbacktemp_16_pattern_twice_timesteps_60_setback_check-res1/Eplus-env-sub_run1/monitor.csv",
        "zone9_21_16_monitor_condensed.csv",
    ),
]
...
for file_name, output_file in tqdm(monitor_files, desc="Processing monitors"):
    process_and_save_monitor(
        dir_path + file_name, out_dir + output_file, columns, utc_col
    )
